  ...
  <div class="col-xs-12">
    <div class="card" id="card-daftar">
      <div class="card-header">
        <h4 class="card-title">Laporan Peramalan per Bulan</h4>
        ...
        <div class="card-block card-dashboard">
          ...
          <div class="row">
            <div class="col-sm-4 col-md-3">
              ...
              <form id="form-tanggal" action="/lapor/bulan" method="GET"></form>
...
<script>
  ...
  $('#tanggal').change(function() {
    if($(this).val()!==''){
      $('#form-tanggal').attr('action', '/lapor/bulan/'+$(this).val()+'/');
      $('#form-tanggal').submit();
    }
  });
  ...
  function cetakLap(kd=-1){
    if($('#card-daftar .card-header .back').is(":visible") || kd>-1){
      $('#form-tanggal').attr('action', '/lapor/cetak_dbulan/'+(kd==-1 ? $('#kd-ramal').val(): kd)+'/');
      $('#form-tanggal').submit();
    }else{
      $('#form-tanggal').attr('action', '/lapor/cetak_bulan/{{ $stanggal }}/');
      $('#form-tanggal').submit();
    }
  }
